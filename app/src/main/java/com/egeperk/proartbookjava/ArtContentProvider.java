...
public class ArtContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.egeperk.proartbookjava.ArtContentProvider";
    ...
    //------- "content://package com.egeperk.proartbookjava.ArtContentProvider/arts"
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        long rowID = sqLiteDatabase.insert(ARTS_TABLE_NAME, null, values);
        if (rowID > 0) {
